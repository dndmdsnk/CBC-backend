...
export default function AdminProductsPage() {
  ...
  return (
    <div className="w-full h-full  max-h-full overflow-y-scroll bg-gray-300 relative">
      <Link
        to="/admin/add-product"
        className="absolute text-2xl cursor-pointer bottom-5 bg-green-500 text-white font-bold py-1 px-3 rounded text-center mx-285"
      >
        +
      </Link>
